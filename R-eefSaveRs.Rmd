...
## Introduction
Coral reefs are one of the most magnificent and ecologically important ecosystems on the planet. They are extremely biodiverse, with 32 of the 35 known animal phyla found within them. Importantly, it is approximated that 25% of all marine life are dependent on coral reefs at some point their life cycles. Overall, coral reefs are an irreplaceable ecosystem, playing an important role in species diversity, productivity, fisheries, coastal protection, human health and livelihoods, and more.

Corals are communal organisms, composed of a colony of polyps. They have also evolved a mutualistic, symbiotic relationship with zooxanthellae which give corals their distinct colors. Corals provide environmental protection and compounds necessary for photosynthesis (carbon dioxide and ammonium) to zooxanthellae, while zooxanthellae provide glucose, glycerol, oxygen, and amino acids for corals. This relationship is quite sensitive and is unfortunately under threat due to a multitude of stressors. In particular, bleaching is affecting coral reefs across the globe. When reefs experience increased light and higher water temperature, zooxanthellae produce charged oxygen molecules (O-). Unfortunately, these charged oxygen molecules are toxic to corals which leads them to expel their zooxanthellae. While corals can survive a bleaching event, they are under more stress without their symbiotic partners and are subject to increased mortality. Collapse of the coral reefs puts the entire ecosystem at risk.
